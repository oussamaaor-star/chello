    ...
    <div className="flex flex-col bg-cream rounded-2xl shadow-2xl shadow-ink/10 border border-ink/10 overflow-hidden"
      ...
      <div className="bg-ink px-4 py-3.5 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-silver flex items-center justify-center text-base">🌸</div>
          <div>
          ...
          <div className="pt-2 flex flex-wrap gap-2">
            {quickTopics.map((tp) => (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-cream-deep hover:bg-silver/10 border border-ink/10 hover:border-silver/30 text-xs text-ink rounded-full transition-all"
              >
      ...
      <div className="px-3 py-3 border-t border-ink/10 flex-shrink-0">
        <div className="flex items-center gap-2 bg-cream-deep rounded-xl px-3 py-2 border border-ink/10 focus-within:border-silver/40 transition-colors">
          <input
            type="text"
            value={input}
    ...
    <div className={`fixed bottom-4 sm:bottom-6 right-4 sm:right-5 rtl:right-auto rtl:left-4 rtl:sm:left-5 z-50 flex-col items-end gap-3 transition-[bottom] duration-300 ${isProductPage ? 'hidden lg:flex' : 'flex'}`}>
      ...
      <div className="flex flex-col items-end gap-3">
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 w-12 h-12 sm:w-auto sm:px-4 sm:py-3 bg-ink hover:bg-ink-soft border border-ink/15 hover:border-silver text-cream rounded-full shadow-lg font-medium text-sm transition-all hover:scale-105 active:scale-95"
        >
