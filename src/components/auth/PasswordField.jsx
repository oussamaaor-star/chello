    ...
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute inset-y-0 right-3 flex items-center text-ink-soft hover:text-gold transition-colors z-10 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-gold/40"
