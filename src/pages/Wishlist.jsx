  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 px-4 text-center bg-cream-deep rounded-3xl border border-dashed border-ink/15">
      <div className="relative mb-6">
        <div className="w-20 h-20 rounded-full bg-silver/10 flex items-center justify-center">
          <Heart className="w-9 h-9 text-silver" />
        </div>
        <div className="absolute -top-1 -right-1 w-7 h-7 rounded-full bg-silver/20 flex items-center justify-center">
  ...
  return (
    <div className="bg-cream min-h-screen">
      ...
      <div className="relative overflow-hidden bg-cream-deep py-14 lg:py-18">
        ...
        <div className="absolute -bottom-12 -left-12 w-60 h-60 rounded-full bg-silver/10 blur-3xl pointer-events-none" />
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <Heart className="w-5 h-5 text-silver fill-silver" />
                <span className="text-[11px] font-semibold tracking-[0.3em] uppercase text-silver-deep">
                  {t('navFavoris')}
                </span>
              </div>
              ...
              <div className="flex flex-col sm:items-end gap-3">
                <div className="flex items-center gap-2">
                  <div className="text-center px-4 py-2 bg-ink/5 rounded-xl">
                    <div className="text-2xl font-serif text-silver leading-none">{count}</div>
