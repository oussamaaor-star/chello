...
export default function Home() {
  ...
  const heroImages = [
    products.find((p) => p.slug === 'trench-coat-multicolore'),
    products.find((p) => p.slug === 'tiour-3-pieces-moutarde'),
    products.find((p) => p.slug === 'set-moutarde-qiladah'),
  ].filter(Boolean);
  ...
  return (
    <div className="bg-cream overflow-x-hidden">
      ...
      ═══════════════════════════════════════════════════════════ */}
      <section ref={heroRef} className="relative overflow-hidden min-h-[90vh] lg:min-h-screen flex items-center">
        {heroImages[0] && (
          <motion.div style={{ y: heroY, scale: heroScale }} className="absolute inset-0">
            <img
              ...
              fetchPriority="high"
            />
            <div className="absolute inset-0 bg-gradient-to-l from-cream via-cream/70 to-cream/30 rtl:bg-gradient-to-r" />
            <div className="absolute inset-0 bg-gradient-to-t from-cream via-transparent to-cream/20" />
          </motion.div>
        )}

        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[15%] left-[10%] rtl:left-auto rtl:right-[10%] w-[400px] h-[400px] rounded-full bg-gold/[0.06] blur-[120px]" />
        </div>

        <motion.div
          style={{ opacity: heroContentOpacity }}
          className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-24 lg:py-0"
        >
          <div className="max-w-xl lg:max-w-lg">
            <motion.p
              ...
              className="text-gold-deep text-[11px] sm:text-xs font-semibold tracking-[0.3em] uppercase mb-7"
            >
            ...
            <div className="overflow-hidden mb-2">
              <motion.h1
                ...
                className="font-serif italic text-[3.2rem] sm:text-6xl lg:text-7xl text-ink leading-[1.05]"
              >
                {lang === 'ar' ? 'أناقتك' : 'Your'}
              </motion.h1>
            </div>
            ...
            <motion.p
              ...
              className="text-ink-soft text-base sm:text-lg leading-relaxed mb-10 max-w-md"
            >
              {lang === 'ar'
            ...
            >
              ...
              >
                <Gem className="w-3.5 h-3.5 text-gold-deep" />
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 max-w-7xl mx-auto">
        <ScrollReveal>
          <p className="text-gold-deep text-[11px] font-semibold tracking-[0.3em] uppercase text-center mb-4">
      ...
      <section ref={lookbookRef} className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          <div className="relative h-[500px] sm:h-[600px] lg:h-[680px]">
            ...
            <div className="absolute -bottom-4 -left-4 rtl:-right-4 rtl:left-auto w-24 h-24 rounded-full border border-gold/30 flex items-center justify-center backdrop-blur-sm bg-cream/60 z-20">
              <span className="font-serif italic text-gold-deep text-[10px] tracking-wider text-center leading-tight">
                {lang === 'ar' ? 'مجموعة\nحصرية' : 'Exclusive\nCollection'}
              </span>
            </div>
          </div>
          ...
          <ScrollReveal className="lg:ps-8">
            <p className="text-gold-deep text-[11px] font-semibold tracking-[0.3em] uppercase mb-5">
            ...
            <Link
              to="/catalogue"
              className="group inline-flex items-center gap-3 border-b-2 border-ink pb-2 text-[13px] font-semibold uppercase tracking-[0.15em] text-ink hover:border-gold-deep hover:text-gold-deep transition-colors"
            >
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        <ScrollReveal variants={scaleIn}>
          <div className="max-w-5xl mx-auto rounded-[2rem] bg-ink relative overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_20%,rgba(184,145,90,0.15),transparent_60%)]" />
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_80%,rgba(184,145,90,0.08),transparent_50%)]" />
            ...
            <div className="relative z-10 px-8 sm:px-14 py-16 sm:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                <div className="w-12 h-12 rounded-full border border-gold/25 flex items-center justify-center mb-6">
                  <Gem className="text-gold-light" size={20} strokeWidth={1.5} />
                </div>
                ...
                <Link
                  to="/fidelite"
                  className="group relative inline-flex items-center gap-3 bg-gold hover:bg-gold-light text-ink font-medium uppercase tracking-[0.15em] text-[13px] rounded-full px-9 py-4 transition-all duration-300 overflow-hidden active:scale-[0.97]"
                >
              ...
              <div className="hidden lg:flex items-center justify-center">
                <div className="relative">
                  {[0, 1, 2].map((i) => (
                    <motion.div
                      key={i}
                      className="absolute rounded-full border border-gold/[0.08]"
                      style={{
                        width: `${160 + i * 80}px`,
                        height: `${160 + i * 80}px`,
                        top: '50%', left: '50%',
                  ...
                  <div className="relative w-20 h-20 rounded-full bg-gold/10 flex items-center justify-center">
                    <span className="font-serif italic text-gold-light text-3xl">8</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 max-w-7xl mx-auto">
        ...
        <ScrollReveal variants={scaleIn}>
          <div className="rounded-2xl overflow-hidden border border-ink/[0.06] shadow-[0_8px_40px_rgba(24,20,15,0.06)]">
            <iframe
              title={lang === 'ar' ? 'موقع متجر Chello' : 'Chello store location'}
              src="https://maps.google.com/maps?q=23.655748,58.182519&t=&z=16&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
